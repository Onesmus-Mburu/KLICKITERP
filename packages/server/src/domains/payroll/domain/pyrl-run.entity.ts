 ...
 * `period_key` `WHERE run_kind='MAIN' AND status='COMMITTED'` — "a payroll
 * period can hold at most one COMMITTED main run; corrections use
 ...
 * is this invariant's read-side lookup.
 *
